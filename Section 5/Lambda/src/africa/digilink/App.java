...
class Runner {
	public void run(Executable e) {
	  ...
	  System.out.println("Executing code block ..."); int value =
	  e.execute("Hello"); System.out.println("Return value is: " + value); }
	...
	public static void main(String[] args) {
		...
		runner.run(new Executable() {
			...
			public int execute(int a,int b) {
				System.out.println("Hello there.");
				// Can't do this in methods of anonymous classes int d = 8;
				return a + b + c;
			}
		});
